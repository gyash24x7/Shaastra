...
function generateExecutor(_a, context) {
    var endpoint = _a.endpoint;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            console.info("Executing \"genql generate\"...");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var devProcess = (0, child_process_1.exec)("genql generate --endpoint ".concat(endpoint, " --output ").concat(context.root, "/node_modules/@genql/runtime/client"), function (error, stdout, stderr) {
                        if (error) {
                            reject(error);
                        }
