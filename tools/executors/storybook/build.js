...
function buildExecutor(_, context) {
    return __awaiter(this, void 0, void 0, function () {
        var projectDir, outputDir;
        return __generator(this, function (_a) {
            console.info("Executing \"build-storybook\"...");
            projectDir = context.workspace.projects[context.projectName].root;
            outputDir = "dist/" + context.workspace.projects[context.projectName].root;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var devProcess = (0, child_process_1.exec)("build-storybook --config-dir=".concat(projectDir, "/.storybook --output-dir=").concat(outputDir, " --modern"), function (error, stdout, stderr) {
                        if (error) {
                            reject(error);
                        }
